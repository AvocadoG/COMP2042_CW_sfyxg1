...
public class Level8 extends Level{
	...
	public void activateAnimal() {
		...
		animallevel8.setmovementX(10.666666*2*1.3);
		animallevel8.setEnd(0);
		animallevel8.setLife(5);
		animallevel8.setCoin(0);
		add(animallevel8);
